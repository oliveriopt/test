...
with DAG(
    ...
    def generate_task_groups(**kwargs):
        ti = kwargs["ti"]
        tables = ti.xcom_pull(task_ids="read_config", key="tables")
        task_groups = []
    ...
    generate_groups = PythonOperator(
        task_id="generate_task_groups",
        python_callable=generate_task_groups,
        provide_context=True,
    )

    read_config >> generate_groups
